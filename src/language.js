let language = [{
    uz: {
        p: 'Assalomu Allaykum!!! Mening ismim Akmal. Men 18 yoshdaman. Men hozirda FrontEnd dasturchisiman. 2 yil  2-son KHMda apparat va dasturiy ta’minot sozlovchisi va 1 yil “Najot talim”da web dasturlash bo‘yicha o‘qidim! Hozirda ozimni ishlab kelayotgan real projectlarga egaman! Lekin hozircha  hech qanday ish tajribasiga ega emasman!! dasturlashga juda qattiq qiziqaman va kelajakda ham shu ish boyicha davom etmoqchiman!!!',
        btn: 'Bog\'lanish',
        skil: 'Men quyidagi Web-texnologiyalarda yetarli bilimga egaman :)',
        header: 'Ko\'nikmalar',
        loyiha: 'Loyihalar',
        contack: 'Bog\'lanish',
    ...
    ru: {
        ...
        btn: 'Связь',
        skil: 'У меня достаточно знаний в следующих веб-технологиях :)',
    ...
    en: {
        p: 'Hi there!!! My name is Akmal. I am 18 years old. I am currently a FrontEnd developer. I studied 2 years as a hardware and software adjuster at KHM No. 2, and 1 year of web programming at "Najot Talim"! I have real projects I\'m working on! But I have no work experience yet!! I am very interested in programming and want to continue it in the future!!!',
        btn: 'Connection',
        skil: 'I have enough knowledge in the following web-technologies :)',
        header: 'Skills',
        loyiha: 'Projects',
        contack: 'Connection',
